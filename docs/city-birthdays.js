...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addCityBirthdays() {
        ...
        const cityBirthdays = [
            ...
            { id: 10001, cityName: "Piedade", name: "Aniversário da Cidade", startDate: "2025-03-19", endDate: "2025-03-19", isHoliday: true, description: "Aniversário de fundação de Piedade em 19/03/1842", restrictionLevel: "low" },
