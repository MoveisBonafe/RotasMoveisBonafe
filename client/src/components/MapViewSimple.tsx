...
export default function MapViewSimple({ 
  ...
  useEffect(() => {
    ...
    if (calculatedRoute && calculatedRoute.length > 2) { // Se a rota tem mais de 2 pontos
    ...
    directionsService.route(request, (result, status) => {
      if (status === google.maps.DirectionsStatus.OK) {
        ...
        try {
          ...
          // Chamar a API AILOG para obter pedágios precisos
          console.log("Obtendo pedágios da API AILOG...");
          ...
          fetchTollsFromAilog(origin, waypoints, selectedVehicleType)
            .then(ailogTolls => {
              ...
              // Adicionar marcadores de pedágio da AILOG
              ailogTolls.forEach(toll => {
                ...
                // Criar infowindow para o pedágio
                const infoContent = `
                  <div style="min-width: 200px;">
                ...
                tollMarker.set('ailogSource', true);
              ...
              // Informar o componente pai sobre os pedágios da AILOG
              if (onRouteCalculated) {
                const resultWithPreciseTolls = {
                  ...result,
                  tollPoints: ailogTolls, // API AILOG é a única fonte de pedágios
                  ailogSource: true
                };
                onRouteCalculated(resultWithPreciseTolls);
              }
              
              // Atualizar marcadores e infowindows
            ...
            .catch(error => {
              ...
              // Em caso de falha na API AILOG, informar componente pai com lista vazia
              if (onRouteCalculated) {
                onRouteCalculated({
                  ...result,
                  tollPoints: [], // Sem pedágios em caso de erro
                  ailogSource: false
                });
              }
              
              // Atualizar marcadores e infowindows sem os pedágios
              setMarkers(newMarkers);
              setInfoWindows(newInfoWindows);
            });
          ...
          // Em caso de erro, informar componente pai sem pedágios
          if (onRouteCalculated) {
  ...
  }, [calculatedRoute, directionsRenderer, directionsService, map, markers, origin, waypoints, onRouteCalculated, infoWindows]);
