...
export default function MapLayersControl({ map }: MapLayersControlProps) {
  ...
  return (
    <div className="absolute bottom-6 left-6 z-40">
      ...
      <div 
        className="bg-white rounded-sm shadow-md p-2 cursor-pointer flex items-center"
      ...
      {/* Menu de opções */}
      {isOpen && (
        <div className="absolute left-0 bottom-12 bg-white rounded shadow-lg overflow-hidden w-48">
